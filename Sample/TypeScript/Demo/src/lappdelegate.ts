...
export class LAppDelegate {
	...
	public _view: LAppView; // View情報
	public _captured: boolean; // クリックしているか
	public _mouseX: number; // マウスX座標
	public _mouseY: number; // マウスY座標
	public _isEnd: boolean; // APP終了しているか
	public _textureManager: LAppTextureManager; // テクスチャマネージャー
}
