...
export class LAppTextureManager {
	...
	public release(): void {
		for (
			const ite: csmVector_iterator<TextureInfo> = this._textures.begin();
...
export class TextureInfo {
	public img: HTMLImageElement; // 画像
	public id: WebGLTexture = null; // テクスチャ
	public width: number = 0; // 横幅
	public height: number = 0; // 高さ
	public usePremultply: boolean; // Premult処理を有効にするか
